...
def vit_b_16_defined(pretrained: bool = False, progress: bool = True, **kwargs) -> VisionTransformer:
    """"
...
def vit_h_14(pretrained = False, progress: bool = True, **kwargs) -> VisionTransformer:
...
def vit_b_16(pretrained: bool = False, progress: bool = True, **kwargs) -> VisionTransformer:
    """"
     Constructs a vit_b_16 architecture from
    `"An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale" <https://arxiv.org/abs/2010.11929>`_.
...
def vit_l_16_defined(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> VisionTransformer:
